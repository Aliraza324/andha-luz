  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`hidden lg:block text-white transition-all duration-300 overflow-hidden ${isScrolled
        ...
        {/* Main Navigation */}
        <div
          className={`transition-all duration-300 px-4 lg:px-8 ${isScrolled
            ? 'py-3 sm:py-3.5'
        ...
        >
          <div className="max-w-7xl mx-auto flex justify-between items-center">
            ...
            {/* Left Links (Desktop) */}
            <nav className={`hidden lg:flex flex-1 items-center gap-8 font-sora text-sm font-semibold tracking-wide transition-colors duration-300 ${isScrolled ? 'text-gray-800' : 'text-white'
              }`}>
              <Dropdown
            ...
            <MotionLink to="/" variants={buttonClick} whileHover="hover" whileTap="tap" className="flex-shrink-0 text-center flex-1 lg:flex-none flex justify-center">
              <img
                ...
                className={`object-contain transition-all duration-300 ${isScrolled ? 'h-10 sm:h-11' : 'h-12 sm:h-14'
                  }`}
              />
            </MotionLink>
            ...
            {/* Right Links (Desktop) */}
            <nav className={`hidden lg:flex flex-1 justify-end items-center gap-8 font-sora text-sm font-semibold tracking-wide transition-colors duration-300 ${isScrolled ? 'text-gray-800' : 'text-white'
              }`}>
              <MotionLink to="/" variants={buttonClick} whileHover="hover" whileTap="tap" className="hover:text-[#dc6941] transition-colors">
                GUIDED TOURS
              </MotionLink>
          ...
          <div className="fixed inset-0 z-[9999] flex lg:hidden">
            ...
            >
              <div className="flex items-center justify-between p-5 border-b border-gray-100 flex-shrink-0">
                <img src={logoImg} alt="The Haven Resort" className="h-10 object-contain" />
